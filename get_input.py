...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "day", help="Enter the day for the problem you are working on."
    )  # noqa: E501
    parser.add_argument(
        "-i", "--input", help="Create the input file.", action="store_true"
    )  # noqa: E501
    parser.add_argument(
        "-p", "--python", help="Create the python template.", action="store_true"
    )  # noqa: E501
    parser.add_argument(
        "-r", "--readme", help="Create the read me template.", action="store_true"
    )  # noqa: E501
...
def make_python_file(day: str, instructions: str) -> None:
    ...
    if os.path.exists(f"Day_{day}/day_{day}_problems.py"):
        ...
        with open(
            f"Day_{day}/day_{day}_problems.py", "r+", encoding="utf-8"
        ) as python_file:
        ...
        with open(
            f"Day_{day}/day_{day}_problems.py", "w", encoding="utf-8"
        ) as python_file:
